...
/projects/p32013/conda_envs/vllm/bin/python3.10 -u inference.py --model /projects/p32013/reasoning/AlphaOne/eval/GARPO1/checkpoints/phi4_softmax1/final --data_name math --output_path results/phi4-softmax1 --batch_size 6 --reasoning 
