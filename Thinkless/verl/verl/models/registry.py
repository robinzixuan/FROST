...
from transformers import LlamaConfig, MistralConfig, GemmaConfig, Qwen2Config, Phi3Config

_REOVEPAD_MODELS = {'llama': LlamaConfig, 'mistral': MistralConfig, 'gemma': GemmaConfig, 'phi3': Phi3Config, 'qwen2': Qwen2Config}
