...
class RewardConfig:
    ...
    # Original DeepScaler reward values
    correct_reward: float = 1.0
    incorrect_reward: float = -1.0
    format_error_reward: float = -1.0
    unk_error_reward: float = -1.0

    # Thinkless reward values
    correct_think_reward: float = 0.5
    correct_short_reward: float = 1.0
    wrong_think_reward: float = -1.0
    wrong_short_reward: float = -1.0
