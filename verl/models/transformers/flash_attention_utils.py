...
FLASH_ATTN_USABLE = False
_flash_supports_window_size = False
_flash_supports_deterministic = False
_flash_deterministic_enabled = False
...
if is_flash_attn_2_available():
    try:
        ...
        FLASH_ATTN_USABLE = True
    except Exception as _flash_e:  # GLIBC or other binary import issues
        # Silently fall back to non-flash attention; downstream will use _flash_attention_forward
        FLASH_ATTN_USABLE = False
...
def _custom_flash_attention_forward(
    ...
    **kwargs,
    ...
    # If flash attention is not usable (e.g., missing GLIBC), fall back immediately
    if not FLASH_ATTN_USABLE:
